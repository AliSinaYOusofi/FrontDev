...
export default function MetaTags() {
    ...
    return (
        <animated.div style={spring}>
            ...
            <CodeBlock code={`<title>Title</title>`} language="html" showCodeEditor={false} />
            ...
            <CodeBlock code={`<meta name="description" content="Description">`} language="html" showCodeEditor={false} />
            ...
            <CodeBlock code={`<meta name="keywords" content="Keywords">`} language="html" showCodeEditor={false} />

            <h1> Viewport Tag </h1>
            <p>
                The viewport tag is used to control the layout and scaling of the web page on mobile devices.
            </p>
            <CodeBlock code={`<meta name="viewport" content="width=device-width, initial-scale=1.0">`} language="html" showCodeEditor={false} />

            <h1> Author Tag </h1>
            <p>
                The author tag is used to provide the name of the author of the web page.
            </p>
            <CodeBlock code={`<meta name="author" content="Author">`} language="html" showCodeEditor={false} />
            
            <h1> Robots Tag </h1>
            <p>
                The robots tag is used to control the crawl behavior of the web page.
            </p>
            <CodeBlock code={`<meta name="robots" content="index, follow">`} language="html" showCodeEditor={false} />
            ...
            <CodeBlock code={`<meta http-equiv="Content-Type" content="text/html; charset=utf-8">`} language="html" showCodeEditor={false} />

            <h1> Refresh Tag </h1>
            <p>
                The refresh tag is used to control the number of seconds before the web page is refreshed.
            </p>
            <CodeBlock code={`<meta http-equiv="refresh" content="numerOfSeconds">`} language="html" showCodeEditor={false} />
