...
export const TechInfo = memo(({name, description, svg, step}) => {
    ...
    return (
        <div className={`${!theme ? "bg-gray-50 " : "bg-gray-950"} md:w-[400px] lg:w-[450px] h- max-h-full gradient-border mx-auto mb-2  rounded-md p-5 transition-all duration-300 hover:scale-[1.01]`}>
